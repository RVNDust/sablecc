...
public class MGetterMacroVtH extends Macro{
    ...
    public MGetterMacroVtH(String pFieldName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setGetterMacroVtH(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("GetterMacroVtH");
        }
        else{
