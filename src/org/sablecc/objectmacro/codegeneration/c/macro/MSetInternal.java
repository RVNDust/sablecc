...
public class MSetInternal extends Macro{
    ...
    private Map<Context, String> field_IndexInsert = new LinkedHashMap<>();
    ...
    public void addSetParams(MStringBuilderBuild macro){
        ...
        void setIndexInsert(
            ...
            this.field_IndexInsert.put(context, value);
        }
    ...
    private String buildIndexInsert(Context context){
    
        return this.field_IndexInsert.get(context);
    }
    ...
    private String getIndexInsert(Context context){
    ...
    public String build(Context context){
        ...
        sb0.append("_");
        sb0.append(buildIndexInsert(context));
        sb0.append("->vt->set");
