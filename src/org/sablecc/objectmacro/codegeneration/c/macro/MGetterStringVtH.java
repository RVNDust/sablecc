...
public class MGetterStringVtH extends Macro{
    ...
    public MGetterStringVtH(String pFieldName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setGetterStringVtH(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("GetterStringVtH");
        }
        else{
