...
public class MInitDirectivesH extends Macro{
    ...
    public MInitDirectivesH(String pParamName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setInitDirectivesH(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("InitDirectivesH");
        }
        else{
        ...
        sb0.append("Directives(struct M");
        sb0.append(buildMacroName(context));
        sb0.append("*);");
