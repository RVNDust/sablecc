...
public class MInternalFieldDeclaration extends Macro{
    ...
    public MInternalFieldDeclaration(String pFieldName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setInternalFieldDeclaration(this);
     }
    ...
    public String build(){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("InternalFieldDeclaration");
        }
        else{
