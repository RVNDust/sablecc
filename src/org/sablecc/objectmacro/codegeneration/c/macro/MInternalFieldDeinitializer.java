...
public class MInternalFieldDeinitializer extends Macro{
    ...
    public MInternalFieldDeinitializer(String pFieldName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setInternalFieldDeinitializer(this);
     }
    ...
    public String build(){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("InternalFieldDeinitializer");
        }
        else{
        ...
        sb0.append("map_deinit(&macro->list_");
