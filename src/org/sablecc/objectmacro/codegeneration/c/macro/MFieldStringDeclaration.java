...
public class MFieldStringDeclaration extends Macro{
    ...
    public MFieldStringDeclaration(String pFieldName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setFieldStringDeclaration(this);
     }
    ...
    public String build(){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("FieldStringDeclaration");
        }
        else{
