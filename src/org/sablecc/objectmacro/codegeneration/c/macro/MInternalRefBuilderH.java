...
public class MInternalRefBuilderH extends Macro{
    ...
    public MInternalRefBuilderH(String pFieldName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setInternalRefBuilderH(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("InternalRefBuilderH");
        }
        else{
