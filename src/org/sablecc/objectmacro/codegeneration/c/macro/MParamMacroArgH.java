...
public class MParamMacroArgH extends Macro{
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setParamMacroArgH(this);
     }
    ...
    public String build(){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("ParamMacroArgH");
        }
        else{
