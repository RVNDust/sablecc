...
public class MInternalStringRefBuilder extends Macro{
    ...
    public MInternalStringRefBuilder(String pFieldName){
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("InternalStringRefBuilder");
        }
        else{
        ...
        sb0.append("{");
        sb0.append(LINE_SEPARATOR);
        sb0.append("    LinkedList *ll = this->vt->get");
        sb0.append(buildFieldName());
        sb0.append("(this, context);");
        sb0.append(LINE_SEPARATOR);
        sb0.append("    if(ll != NULL)");
        sb0.append(LINE_SEPARATOR);
        sb0.append("    ");
        sb0.append("{");
        sb0.append(LINE_SEPARATOR);
        sb0.append("        return ll->vt->toString(ll);");
        sb0.append(LINE_SEPARATOR);
        sb0.append("    }");
        sb0.append(LINE_SEPARATOR);
        sb0.append("    return \"\";");
