...
public class MFieldMacroInitializer extends Macro{
    ...
    public MFieldMacroInitializer(String pFieldName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setFieldMacroInitializer(this);
     }
    ...
    public String build(){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("FieldMacroInitializer");
        }
        else{
