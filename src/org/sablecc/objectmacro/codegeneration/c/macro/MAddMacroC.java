...
public class MAddMacroC extends Macro{
    ...
    public MAddMacroC(String pFieldName){
    ...
    public void addParamArg(MParamMacroArgC macro){
        if(macro == null){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setAddMacroC(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("AddMacroC");
        }
        else{
        ...
        sb0.append(", sizeof(");
        MParamMacroArgName minsert_2 = new MParamMacroArgName();
        
        
        sb0.append(minsert_2.build(null));
        sb0.append("));");
        sb0.append(LINE_SEPARATOR);
        sb0.append("    //this->children->vt->addLast(this->children, macro, sizeof(macro));");
        sb0.append(LINE_SEPARATOR);
