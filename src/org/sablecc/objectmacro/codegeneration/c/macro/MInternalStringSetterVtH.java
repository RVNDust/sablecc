...
public class MInternalStringSetterVtH extends Macro{
    ...
    public MInternalStringSetterVtH(String pFieldName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setInternalStringSetterVtH(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("InternalStringSetterVtH");
        }
        else{
        ...
        sb0.append("*, Context *key,void* value);");
