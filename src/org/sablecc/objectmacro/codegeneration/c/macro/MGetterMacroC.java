...
public class MGetterMacroC extends Macro{
    ...
    public MGetterMacroC(String pFieldName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setGetterMacroC(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("GetterMacroC");
        }
        else{
