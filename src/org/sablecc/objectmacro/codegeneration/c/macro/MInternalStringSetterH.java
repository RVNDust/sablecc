...
public class MInternalStringSetterH extends Macro{
    ...
    public MInternalStringSetterH(String pFieldName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setInternalStringSetterH(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("InternalStringSetterH");
        }
        else{
