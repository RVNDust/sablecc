...
public class MParamRef extends Macro{
    ...
    public MParamRef(String pName, String pParamName){
    ...
    private void initGetParamsDirectives(){
        ...
        sb0.append(", ");
        this.GetParamsBeforeFirst = new DBeforeFirst(sb0.toString());
        this.GetParamsValue.setBeforeFirst(this.GetParamsBeforeFirst);
    }
