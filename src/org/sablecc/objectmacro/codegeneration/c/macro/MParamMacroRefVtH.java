...
public class MParamMacroRefVtH extends Macro{
    ...
    public MParamMacroRefVtH(String pName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setParamMacroRefVtH(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("ParamMacroRefVtH");
        }
        else{
