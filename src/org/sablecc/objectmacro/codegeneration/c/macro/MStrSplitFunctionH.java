...
public class MStrSplitFunctionH extends Macro{
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setStrSplitFunctionH(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("StrSplitFunctionH");
        }
        else{
