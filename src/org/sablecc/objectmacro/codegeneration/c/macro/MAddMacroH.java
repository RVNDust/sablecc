...
public class MAddMacroH extends Macro{
    ...
    public MAddMacroH(String pFieldName){
...
//        this.ParamArgsValue.setSeparator(this.ParamArgsSeparator);
    ...
    @Override
     ...
     void apply(
         ...
         internalsInitializer.setAddMacroH(this);
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("AddMacroH");
