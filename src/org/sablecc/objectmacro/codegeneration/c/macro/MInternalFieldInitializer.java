...
public class MInternalFieldInitializer extends Macro{
    ...
    public MInternalFieldInitializer(String pFieldName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setInternalFieldInitializer(this);
     }
    ...
    public String build(){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("InternalFieldInitializer");
        }
        else{
        ...
        sb0.append("map_init(&macro->list_");
