...
public class MGetterMacroH extends Macro{
    ...
    public MGetterMacroH(String pFieldName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setGetterMacroH(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("GetterMacroH");
        }
        else{
