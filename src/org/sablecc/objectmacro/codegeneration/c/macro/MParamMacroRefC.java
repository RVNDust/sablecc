...
public class MParamMacroRefC extends Macro{
    ...
    public MParamMacroRefC(String pName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setParamMacroRefC(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("ParamMacroRefC");
        }
        else{
