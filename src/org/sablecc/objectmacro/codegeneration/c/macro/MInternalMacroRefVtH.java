...
public class MInternalMacroRefVtH extends Macro{
    ...
    public MInternalMacroRefVtH(String pName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setInternalMacroRefVtH(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("InternalMacroRefVtH");
        }
        else{
        ...
        sb0.append("struct InternalValue* (*get");
