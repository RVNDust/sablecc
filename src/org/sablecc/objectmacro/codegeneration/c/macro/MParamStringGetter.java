...
public class MParamStringGetter extends Macro{
    ...
    public MParamStringGetter(String pFieldName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setParamStringGetter(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("ParamStringGetter");
        }
        else{
