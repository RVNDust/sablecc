...
public class MInternalMacroRefC extends Macro{
    ...
    public MInternalMacroRefC(String pParamName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setInternalMacroRefC(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("InternalMacroRefC");
        }
        else{
        ...
        sb0.append("    return map_get(&(this->list_");
        sb0.append(buildParamName());
        sb0.append("), context);");
        sb0.append(LINE_SEPARATOR);
        sb0.append("}");
