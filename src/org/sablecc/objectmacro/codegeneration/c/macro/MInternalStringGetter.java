...
public class MInternalStringGetter extends Macro{
    ...
    public MInternalStringGetter(String pFieldName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setInternalStringGetter(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("InternalStringGetter");
        }
        else{
        ...
        sb0.append("{");
        sb0.append(LINE_SEPARATOR);
        sb0.append("    char* value = map_get(&this->list_");
        sb0.append(buildFieldName());
        sb0.append(", key);");
        sb0.append(LINE_SEPARATOR);
        sb0.append("    return value;");
        sb0.append(LINE_SEPARATOR);
        sb0.append("}");
