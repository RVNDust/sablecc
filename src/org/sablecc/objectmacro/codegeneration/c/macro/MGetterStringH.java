...
public class MGetterStringH extends Macro{
    ...
    public MGetterStringH(String pFieldName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setGetterStringH(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("GetterStringH");
        }
        else{
