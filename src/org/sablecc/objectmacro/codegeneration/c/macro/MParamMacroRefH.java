...
public class MParamMacroRefH extends Macro{
    ...
    public MParamMacroRefH(String pName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setParamMacroRefH(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("ParamMacroRefH");
        }
        else{
