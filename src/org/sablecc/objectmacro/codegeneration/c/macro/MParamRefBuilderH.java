...
public class MParamRefBuilderH extends Macro{
    ...
    public MParamRefBuilderH(String pFieldName){
    ...
    @Override
     void apply(
         ...
         internalsInitializer.setParamRefBuilderH(this);
     }
    ...
    public String build(Context context){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("ParamRefBuilderH");
        }
        else{
